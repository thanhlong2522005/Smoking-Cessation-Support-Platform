...
public class UserService {
    ...
    public List<User> getAllByRole(String roleStr) {
        for (UserRole role : UserRole.values()) {
            if (role.name().equalsIgnoreCase(roleStr)) {
                return userRepository.findByRole(role);
            }
        }
        throw new IllegalArgumentException("Không tồn tại vai trò: " + roleStr);
    }
    ...
    public User updateCessationInfo(Long userId, LocalDate quitStartDate, Integer cigarettesPerDay, Double costPerPack,Integer cigarettesPerPack, String cessationGoal, LocalDate expectedQuitDate ) {
        ...
        user.setCigarettesPerPack(cigarettesPerPack);
